const one = document.getElementById("ones").childNodes;
let len = document.getElementById("ones").childNodes.length;
...
document.addEventListener("rollDice", function (e) {
  ...
  haha.innerHTML = `<p>Total rolls: <span>${diceValue}</span></p>`;
