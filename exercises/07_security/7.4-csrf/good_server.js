      ...
      request.on("end", function () {
        ...
        if (userArray.length === 1) {
          ...
          response.setHeader("Set-Cookie", [
            "secret_for_good_server=" + currentUser.cookie_secret,
          ]);
          response.end(
            `
                            <!doctype html>
          ...
          response.end(
            `${response.statusCode} - Wrong username and/or password!`
          );
          return;
        }
      });
          ...
          ` 
                ...
                <body>
                    ...
                    <form action="/money_transfer" method="get">
                        <div class="container">
                        <input type="hidden" name="csrf_token" id="csrf-token" value="setCSRFtoken()" />
